            ...
            <div className="md:col-span-1 space-y-6">
                ...
                <div className="w-full bg-background rounded-2xl p-4 border border-border-color flex flex-col items-center justify-center gap-3">
                    ...
                    <div className="flex items-center justify-center gap-2 w-full">
                        <a href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(shareUrl)}`} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-[#1877F2]/10 text-[#1877F2] hover:bg-[#1877F2] hover:text-white transition-all dark:bg-[#1877F2]/20 dark:text-[#1877F2] dark:hover:text-white"><Facebook size={20} /></a>
                        <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(fullShareText)}&url=${encodeURIComponent(shareUrl)}`} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-black/5 text-black hover:bg-black hover:text-white transition-all dark:bg-white/10 dark:text-white dark:hover:bg-white dark:hover:text-black"><Twitter size={20} /></a>
                        <a href={`https://api.whatsapp.com/send?text=${encodeURIComponent(fullShareText + ' ' + shareUrl)}`} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366] hover:text-white transition-all dark:bg-[#25D366]/20 dark:text-[#25D366] dark:hover:text-white"><WhatsAppIcon /></a>
                        <a href={`https://t.me/share/url?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent(fullShareText)}`} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-[#0088cc]/10 text-[#0088cc] hover:bg-[#0088cc] hover:text-white transition-all dark:bg-[#0088cc]/20 dark:text-[#0088cc] dark:hover:text-white"><TelegramIcon /></a>
                    </div>
                </div>
            </div>
            </div>
